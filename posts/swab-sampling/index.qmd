...
* What is the expected relative abundance of a human-infecting stealth virus?[^1]
...
[^1]: The shedding dynamics of a **stealth pathogen** are likely to be different from SARS-CoV-2, so we need to be careful about generalizing from samples that originate from SARS-CoV-2 patients, particularly if they are hospitalized.
