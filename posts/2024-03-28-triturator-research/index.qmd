...
def return_airline_trit_dict():
    ...
    with open("data/2024-03-28_airlines_triturators.tsv") as infile:
        reader = csv.DictReader(infile, delimiter='\t')
        for row in reader:
            airline = row['Airline'].strip()
            triturator = row['Triturator'].strip()
            prettier_triturator = {
                "Swissport": "Swissport\nTriturator",
            ...
            triturator = prettier_triturator.get(triturator, triturator)
...
from IPython.display import Markdown
from tabulate import tabulate
table = pd.read_csv("data/2024-03-28_airlines_triturators.tsv", sep="\t")[["Airline", "Triturator","Ground handling", "Source",]]
Markdown(tabulate(
  table.values,
