...
I'm adapting mgs-workflow to take in single-read sequencing data. Here I'm checking if: i) the output of the single-read RAW and CLEAN workflows look as expected, and ii) ifthe output of the paired-end version is the same as the output of the test run on `dev`.
