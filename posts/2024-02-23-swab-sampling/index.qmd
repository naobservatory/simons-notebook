...
sns.pointplot(data=mean_ct_diff, y='Study & Comparison', x='CT Difference', linestyles='none', markers='D', color='#36454F', markersize=5, errorbar=None, order=order,zorder=1)
